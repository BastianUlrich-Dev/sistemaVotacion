...
-- Tiempo de generación: 18-01-2024 a las 22:28:48
...
(1, 'Michelle bacheletato'),
(2, 'Sebastián piñatubo'),
(3, 'Ricardo lagartija'),
(4, 'Eduardo freirework');
...
CREATE TABLE IF NOT EXISTS `votos` (
  `id` int NOT NULL AUTO_INCREMENT,
  `nombreApellido` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  ...
  `comoSeEntero` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `fechaVoto` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
...
INSERT INTO `votos` (`id`, `nombreApellido`, `alias`, `rut`, `email`, `region`, `comuna`, `candidato`, `comoSeEntero`, `fechaVoto`) VALUES
(10, 'Mastias', 'Matimati', '11.111.111-1', 'mastias@gmail.com', 7, 86, '1', 'web', '2024-01-18 22:28:13');
COMMIT;
